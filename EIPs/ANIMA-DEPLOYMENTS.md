...
|----------|---------|---------|------|
| **ANIMARegistry** | `0x36F7702045C7755174aaA88B62152343B50e0e75` | v2.0.0 | 2026-02-25 |
| **ANIMA Genesis** | `0x4e8D3B9Be7Ef241Fb208364ed511E92D6E2A172d` | v1.0.0 | 2026-02-21 |
...
- **Two-tier withdrawal protection:**
  ...
  - `ownerWithdrawalAllowed` — per-ANIMA owner setting
...
**ANIMA Genesis Token #1** is bound as a demo:
...
- Source: `Pentagon-AI/EIPs/ERC-6551A/contracts/ANIMARegistry.sol`
...
|----------|---------|-------|
| ANIMARegistry v1 | `0x327165c476da9071933d4e2dbb58efe2f6c9f486` | No withdrawal controls |
| ANIMARegistry (old) | `0xd68dab3c4cdbbc4a615c1869b6a44c4fa0764e34` | Solidity 0.8.33 - MCOPY opcode not supported |
| ANIMARegistry (older) | `0x6B81e00508E3C449E20255CdFb85A0541457Ea6d` | Different function signatures |
...
- Unbind agent
- Pre-filled with ANIMA Genesis Token #1 example
