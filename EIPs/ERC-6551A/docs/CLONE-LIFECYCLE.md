...
Cloning in ERC-6551A creates agent copies without creating new NFT tokens. Clones exist in "limbo" until claimed, enabling flexible ownership and trading paths.
