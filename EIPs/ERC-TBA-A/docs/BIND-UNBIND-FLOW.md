...
ERC-TBA-A allows agents to bind to any ERC-721 NFT. This document covers all binding scenarios.
...
Unlike ERC-6551 (deterministic addresses), ERC-TBA-A bindings don't auto-transfer. New owner must:
